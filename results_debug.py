...
_results_dir = 'result/Intertemp-20241022T1947'
...
colors = {
    'Biomass Plant': '#AEC6CF',         # Pastel blue for biomass
    'Wind (onshore)': '#4CA6A8',        # Pastel turquoise for onshore wind
    'Wind (offshore)': '#009B77',       # A darker pastel teal for offshore wind
    'Nuclear Plant': '#FFB6C1',         # Light pastel pink for nuclear
    'Hydro (run-of-river)': '#A0C4E1',  # Light pastel blue for run-of-river hydro
    'Hydro (reservoir)': '#74B3D6',     # Slightly darker blue for reservoir hydro
