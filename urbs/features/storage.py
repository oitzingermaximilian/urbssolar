...
def specific_storage_cost(m, stf, sit, sto, com, cost_type):
    ...
    if cost_type == 'Invest':
        ...
        cost_spec_storage = 0
        return m.storage_costs[stf, sit, sto, com, cost_type] == cost_spec_storage
    # Costs urbs-solar added TODO add to cost dict
    elif cost_type == 'Import Solar':
        return m.costs[cost_type] == 0
    elif cost_type == 'Storage Solar':
        return m.costs[cost_type] == 0
    elif cost_type == 'EU Primary Manufacture Solar':
        return m.costs[cost_type] == 0
    elif cost_type == 'EU Secondary Manufacture Solar':
        return m.costs[cost_type] == 0
    #elif cost_type == 'Import_Solar_cost':
    #    cost_spec_storage = 0
    #    return m.storage_costs[stf, sit, sto, com, cost_type] == cost_spec_storage
    #elif cost_type == 'Stock_Solar_cost':
    #    cost_spec_storage = 0
    #    return m.storage_costs[stf, sit, sto, com, cost_type] == cost_spec_storage
    #elif cost_type == 'EU_manufacturing_cost':
    #    cost_spec_storage = 0
    #    return m.storage_costs[stf, sit, sto, com, cost_type] == cost_spec_storage
    else:
