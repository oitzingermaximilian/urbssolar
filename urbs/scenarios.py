...
#base
def scenario_base(data,data_urbsextensionv1,param_dict,instalable_capacity_dict,dcr_dict,stocklvl_dict):
    # do nothing
    return data,data_urbsextensionv1,param_dict, instalable_capacity_dict,dcr_dict,stocklvl_dict
